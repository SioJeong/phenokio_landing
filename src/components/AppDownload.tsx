    ...
    >
      <div className="relative z-10 w-full max-w-[319px] mx-auto flex flex-col gap-12 items-center">
        ...
        <div className="flex flex-col gap-6 items-center w-[270px]">
          ...
          {/* Title */}
          <h2
            className="font-bold text-[28px] text-[#082b61] leading-[1.35] tracking-[-0.9px] text-center w-full"
          ...
          {/* Description */}
          <p className="font-medium text-[20px] text-[#363d47] leading-[1.4] text-center whitespace-pre-wrap">
            멀리있어도 부모님의 하루를{"\n"}안심할 수 있도록 도와드려요!
          </p>
        </div>
        ...
        {/* Download Section */}
        <div className="bg-[rgba(254,254,254,0.2)] border border-[#fefefe] rounded-[20px] p-5 flex flex-col gap-2 w-full">
        ...
        <div className="bg-[rgba(254,254,254,0.5)] border border-[#fefefe] rounded-[20px] p-5 flex flex-col gap-3 w-[319px]">
          ...
          <button
            onClick={handleShare}
            className="w-full bg-[#2d7bf2] rounded-[12px] px-4 py-4 flex items-center justify-center gap-3 font-semibold text-[18px] text-[#fefefe] leading-[1.35] tracking-[-0.18px]"
          >
            <svg
              width="22"
              height="22"
        ...
        <div className="bg-[rgba(254,254,254,0.5)] border border-[#fefefe] rounded-[20px] p-5 flex flex-col gap-4 items-center w-[319px]">
          <div className="flex flex-col gap-3 items-center text-center w-full">
            ...
            <p className="font-medium text-[16px] leading-[1.4]">
              ...
              <span className="text-[#5d6673] text-sm">
                (평일 10:00 ~ 19:00)
              </span>
            </p>
          </div>
          <button
            ...
            className="w-full bg-[#FEE500] rounded-[12px] px-4 py-4 flex items-center justify-center gap-3 font-semibold text-[18px] text-[#000000] leading-[1.35] tracking-[-0.18px]"
          >
            <img src="/kakao.svg" alt="카카오톡 아이콘" className="w-5 h-5" />
            카카오톡 문의하기
          </button>
        </div>
      </div>
