...
const Hero = ({ onCTAClick }: HeroProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[375px] mx-auto text-center px-6 flex flex-col justify-center flex-1">
        {/* Logo Image */}
        ...
        {/* CTA Buttons */}
        <div className="relative z-20 space-y-4 px-[28px] mt-4">
          <Button
            size="lg"
