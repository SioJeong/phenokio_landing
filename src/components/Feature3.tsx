  ...
  return (
    <section className="relative min-h-[812px] flex items-center justify-center bg-[#f9fafc] overflow-hidden">
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle at center top, rgba(255, 243, 219, 1) 0%, rgba(255, 255, 255, 0) 50%)'
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-[375px] mx-auto text-center pt-[180px] pb-4">
        ...
        <div className="inline-flex items-center justify-center bg-[#fefefe] border border-[#FFB114] rounded-full px-[25px] py-3 mb-6">
          <span className="text-lg font-medium italic text-[#FFB114]">Feature 3</span>
        </div>
        ...
        <div className="relative w-full max-w-[375px] mx-auto">
          ...
          <div className="absolute left-[calc(50%+25px)] -translate-x-1/2 top-[-20px] w-[260px] bg-[#fefefe] rounded-[17px] shadow-[0px_-4px_18px_0px_rgba(8,38,97,0.1)] p-[17px]">
            <div className="mb-[7px]">
              <p className="text-xs font-semibold text-[#363d47] opacity-70 text-left mb-[2px]">이동 거리</p>
              <div className="flex items-end gap-[3px]">
                <span className="text-[19px] font-bold text-[#363d47] leading-[1.35]">2.3</span>
                <span className="text-[13.5px] font-medium text-[#363d47] opacity-70 leading-[1.4] pb-[2.5px]">km</span>
              </div>
            </div>
            <div className="flex items-center gap-[7px] bg-white rounded-lg">
              <Info className="w-[11px] h-[11px] text-[#039855] flex-shrink-0" strokeWidth={2} />
          ...
          <div className="absolute left-[calc(50%-25px)] -translate-x-1/2 top-[70px] w-[260px] bg-[#fefefe] rounded-[16px] shadow-[0px_-4.32px_18px_0px_rgba(8,38,97,0.1)] p-[16px] z-10">
            <div className="mb-[7px]">
              <p className="text-xs font-semibold text-[#363d47] opacity-70 text-left mb-[2px]">오늘 걸음 수</p>
              <div className="flex items-end gap-[3px]">
                <span className="text-[18px] font-bold text-[#363d47] leading-[1.35]">7,234</span>
                <span className="text-[13px] font-medium text-[#363d47] opacity-70 leading-[1.4] pb-[2.5px]">걸음</span>
              </div>
            </div>
            ...
            <div className="relative h-[152px] w-[228px] mt-[7px]">
              ...
              {/* X-axis labels */}
              <p className="absolute left-0 top-[136px] text-[10px] text-[#8d94a0] opacity-70 leading-[1.4] tracking-[-0.1px]">0시</p>
              <p className="absolute left-[55px] top-[136px] text-[10px] text-[#8d94a0] opacity-70 leading-[1.4] tracking-[-0.1px]">6시</p>
              <p className="absolute left-[114px] top-[136px] text-[10px] text-[#8d94a0] opacity-70 leading-[1.4] tracking-[-0.1px]">12시</p>
              <p className="absolute left-[173px] top-[136px] text-[10px] text-[#8d94a0] opacity-70 leading-[1.4] tracking-[-0.1px]">18시</p>
                ...
                <div className="absolute left-[3px] bottom-full -translate-x-1/2 pb-[6px]">
                  <div className="bg-[#eaecf0] rounded-full px-[10px] py-[3px] shadow-[5px_5px_44px_0px_rgba(0,0,0,0.05)] whitespace-nowrap">
                    <div className="flex items-end gap-0">
                      <span className="text-xs font-semibold text-[#363d47] opacity-70 leading-[1.4] tracking-[-0.11px]">2,211</span>
                      <span className="text-[10px] text-[#363d47] opacity-70 leading-[1.4] tracking-[-0.1px] pb-[1.5px]">걸음</span>
                    </div>
                  </div>
